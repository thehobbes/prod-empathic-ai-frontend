...
// }
//
// function MainPageInner({ apiBaseUrl, humeConfigId, liveVoiceMessage }) {
...
//
//   useEffect(() => {
//     if (!liveVoiceMessage?.message?.type) {
//       return;
//     }
//
//     forwardEviEvent(liveVoiceMessage.message);
//   }, [forwardEviEvent, liveVoiceMessage]);
//
//   useEffect(() => {
...
//     () => prosodyScoresToSignals(eventForwarder.latestProsodyFrame?.prosodyScores, 6),
...
//       </div>
//
//       <div className="w-[520px] bg-[#F4F3ED] flex flex-col h-full border-l border-[#E5E4DC] p-6 shrink-0">
...
//       onMessage={(message) => {
//         setLiveVoiceMessage((currentState) => ({
//           sequence: currentState.sequence + 1,
//           message,
//         }));
//       }}
//     >
//       <MainPageInner {...props} liveVoiceMessage={liveVoiceMessage} />
//     </VoiceProvider>
//   );
// }
//
